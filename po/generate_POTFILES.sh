...
(
 ...
 #do not include files from POTFILES.skip in the generated list
) | grep -vx -f POTFILES.skip > POTFILES.py.in.new


diff -q POTFILES.py.in.new POTFILES.py.in ||:
mv POTFILES.py.in.new POTFILES.py.in

rm -f POTFILES.xml.in.new
...
(
 ...
 cd ..
 find share/ui -name '*.ui' -type f -print | sort
 find share/ui -name '*.glade' -type f -print | sort
 find share/ui -name '*.xml' -type f -print | sort
 find share/extensions -name '*.inx' -type f -print | sort
 cd po

 #do not include files from POTFILES.skip in the generated list
) | grep -vx -f POTFILES.skip > POTFILES.xml.in.new


diff -q POTFILES.xml.in.new POTFILES.xml.in ||:
mv POTFILES.xml.in.new POTFILES.xml.in
echo "Done."
echo ""
