...
void InkscapePreferences::initPageRendering()
{
    ...
    _page_rendering.add_line( false, _("Rendering tile multiplier:"), _rendering_tile_multiplier, "",
                              _("Increase to get a better performance when there are large areas with filtered objects in your drawing. Decrease to make zooming and panning in relevant areas faster on low-end hardware in drawings with few or no filters."), false);
