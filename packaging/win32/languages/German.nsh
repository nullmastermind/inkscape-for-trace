...
${LangFileString} DeletePrefsDesc "Löscht verbliebene persönliche Inkscape-Einstellungen einer vorhergehenden Installation"
${LangFileString} Python "Python 2.7"
${LangFileString} PythonDesc "Ein Interpreter für die Python Programmiersprache und Python Module zur Ausführung von Erweiterungen."
...
${LangFileString} ExamplesDesc "Beispieldateiewn die mit Inkscape erstellt wurden"
